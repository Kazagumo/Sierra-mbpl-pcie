...
static const struct mhi_channel_config mhi_sierra_em919x_channels[] = {
	...
	MHI_CHANNEL_CONFIG_UL(8, "QDSS", 16, 0),
	MHI_CHANNEL_CONFIG_DL(9, "QDSS", 16, 0),
	...
	MHI_CHANNEL_CONFIG_UL(32, "DUN", 32, 0),
	MHI_CHANNEL_CONFIG_DL(33, "DUN", 32, 0),
	MHI_CHANNEL_CONFIG_HW_UL(100, "IP_HW0_MBIM", 512, 1),
	MHI_CHANNEL_CONFIG_HW_DL(101, "IP_HW0_MBIM", 512, 2),
	MHI_CHANNEL_CONFIG_HW_DL(102, "IP_HW_ADPL", 128, 3),
};
...
static struct mhi_event_config modem_sierra_em919x_mhi_events[] = {
	...
	MHI_EVENT_CONFIG_HW_DATA(3, 1024, 102), 
};
...
static const struct pci_device_id mhi_pci_id_table[] = {
	...
	/* EM929x (sdx65), use the same vid:pid as qcom-sdx65m */
